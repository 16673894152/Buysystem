...
public class CreateMapUtil {
    ...
    private static String version = "1.9 beta";
                            ...
                            for (ForeignKey foreignKey : foreignKeyTemp) {
                                if (foreignKey != null) {
                                    if (!temp1.contains(foreignKey.fkColumn)) {
                                        ...
                                        temp2 += "#{" + lineToHump(foreignKey.fkColumn) + "." + lineToHump(foreignKey.pkColumn) + "},";
                                    }
                                }
                            }
                        }
                        ...
                        if (mapUtil != null) {
                            ...
                            for (ForeignKey foreignKey : foreignKeyTemp) {
                                if (foreignKey != null) {
                                    if (!temp1.contains(foreignKey.fkColumn)) {
                                        temp1 += foreignKey.fkColumn + ",";
                                        temp2 += "#{item." + lineToHump(foreignKey.fkColumn) + "." + lineToHump(foreignKey.pkColumn) + "},";
                                    }
                                }
                            }
                        }
    ...
    public static void write() {
        ...
        //生成配置
        for (String i : set) {
            CreateMapUtil inst = instancePool.get(i);
